...
<body bgcolor="#0a06ff"> <!-- Set default background color-->
    ...
    <p><b><a href="./assign9.php">Select A Flight</a></b></p>  <!-- link to the page to select a passenger and view flight history-->
    <p><b><a href="./assign9selectPassenger.php">Select A Passenger</a></b></p>  <!-- link to the page to select a passenger and view flight history-->
